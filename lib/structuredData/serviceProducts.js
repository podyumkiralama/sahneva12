...
export function buildGlobalServiceProductGraph() {
  const graph = serviceProducts.flatMap((entry) => {
...
export const SERVICE_PRODUCTS_JSON = JSON.stringify(
  buildGlobalServiceProductGraph(),
);

if (typeof globalThis !== "undefined") {
  globalThis.SERVICE_PRODUCTS_JSON = SERVICE_PRODUCTS_JSON;
}
