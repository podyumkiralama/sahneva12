...
export const LOCALE_CONTENT = {
  tr: {
    ...
    // ✅ EKLENEN KISIM: İletişim Sayfası Verileri
    contact: {
      title: "İletişim",
      ...
      submitButton: "Gönder",
      // .map() hatasını çözen dizi burası:
      info: [
  ...
  ar: {
    ...
    // ✅ EKLENEN KISIM (AR): Hatanın kaynağı burasıydı
    contact: {
      title: "اتصل بنا",
      ...
      messageLabel: "رسالتك",
      submitButton: "إرسال",
      // Bu 'info' dizisi olmadığı için .map hatası alıyordunuz
      info: [
