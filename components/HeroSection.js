  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        {/* Glow */}
        <div
          className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[420px] bg-purple-600/18 blur-[130px] rounded-full mix-blend-screen pointer-events-none"
          aria-hidden="true"
        />
      </div>
