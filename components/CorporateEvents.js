...
// —————————————————————————————————————————
// YAPILANDIRMA & VERİLER (KURUMSAL + A11Y)
// —————————————————————————————————————————
...
const DEFAULT_CARDS = [
  {
    ...
    icon: "🚀",
    iconLabel: "Roket ikonu - Yüksek etki",
  ...
  },
  {
    ...
    icon: "🎤",
    iconLabel: "Mikrofon ikonu - Profesyonel ses",
  ...
  },
  {
    ...
    icon: "🤝",
    iconLabel: "El sıkışma ikonu - İşbirliği",
    badge: "Tam Çözüm",
  },
];
...
const DEFAULT_ADVANTAGES = [
  ...
  {
    icon: "🛡️",
    iconLabel: "Kalkan ikonu",
    label: "Kurumsal Güvence",
    desc: "Sözleşmeli hizmet, faturalı süreç ve teknik süpervizör desteği.",
    colorClass:
      "text-amber-600 bg-amber-50 group-hover:bg-amber-600 group-hover:text-white",
  },
];
...
export default function CorporateEvents({
  ...
  return (
    ...
    >
      {/* Modern Arka Plan Deseni - Dekoratif */}
      <div
        className="absolute inset-0 pointer-events-none opacity-[0.4]"
        aria-hidden="true"
      >
        <div className="absolute h-full w-full bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] [background-size:24px_24px] [mask-image:radial-gradient(ellipse_60%_50%_at_50%_0%,#000_70%,transparent_100%)]" />
      </div>
      ...
      <div className="container relative z-10 px-4 mx-auto">
        ...
        {/* 1. HİZMET KARTLARI */}
        <div
          className="grid gap-8 lg:gap-10 md:grid-cols-3 mb-20 lg:mb-24"
          role="list"
        >
          {cards.map((card, i) => {
            const cardCtaLabel =
                ...
                >
                  ...
                  <div className="relative aspect-[4/3] w-full overflow-hidden">
                    ...
                    <div className="absolute top-5 right-5">
                      <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-slate-900/90 backdrop-blur-md text-white border border-white/30 shadow-sm">
                    ...
                    {/* İkon */}
                    <div
                      className="absolute bottom-5 left-5 w-12 h-12 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl flex items-center justify-center text-2xl shadow-lg"
                      role="img"
                      aria-label={card.iconLabel || "Hizmet ikonu"}
                    >
                      {card.icon}
                    </div>
                  </div>
                  ...
                  <div className="flex-1 p-8 flex flex-col">
                    ...
                    <div className="pt-6 border-t border-slate-100 mt-auto">
                      <Link
                        ...
                        className="inline-flex items-center gap-2 font-bold text-sm text-slate-900 hover:text-blue-600 transition-colors group/link focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded"
        ...
        <div className="mb-20">
          ...
          >
            {advantages.map((item, i) => (
              ...
              >
                {/* Hover Arka Plan – Dekoratif */}
                <div
                  className="absolute inset-0 rounded-2xl bg-slate-100 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  aria-hidden="true"
                />
                ...
                <div className="relative z-10">
                  <div
                    ...
                    role="img"
                    aria-label={item.iconLabel || "Avantaj ikonu"}
                  >
                    {item.icon}
                  </div>
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-10">
              <a
                ...
                className="inline-flex h-14 items-center justify-center gap-3 rounded-full bg-white text-slate-950 font-bold px-8 transition-all hover:bg-blue-50 hover:scale-105 shadow-[0_0_20px_rgba(255,255,255,0.3)] focus:outline-none focus:ring-4 focus:ring-white/50 focus:ring-offset-2 focus:ring-offset-slate-900"
                aria-label={`${dictionary.phoneCtaLabel} — ${dictionary.phoneCtaAria}`}
              >
              ...
              <a
                ...
                className="inline-flex h-14 items-center justify-center gap-3 rounded-full border border-white/20 bg-white/10 backdrop-blur-sm text-white font-bold px-8 transition-all hover:bg-white/20 hover:scale-105 focus:outline-none focus:ring-4 focus:ring-white/30 focus:ring-offset-2 focus:ring-offset-slate-900"
                aria-label={`${dictionary.whatsappCtaLabel} — ${dictionary.whatsappCtaAria} — ${dictionary.whatsappSrHint}`}
              >
                <span className="text-xl" aria-hidden="true">
                  💬
                </span>
            ...
            {/* Alt Güven Rozetleri */}
            <div
              className="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 text-sm font-medium text-slate-400"
              role="list"
              aria-label="Hizmet garantileri"
            >
