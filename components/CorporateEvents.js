      ...
      <div className="container relative z-10 mx-auto px-4">
        ...
        <div className="mb-12">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm max-w-2xl mx-auto">
              Profesyonel ekipman ve deneyimli teknik kadromuzla kurumsal etkinliklerinizde yanınızdayız
            </p>
          </div>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 id="cta-title" className="text-xl md:text-2xl font-bold mb-3">
              Kurumsal Etkinlikleriniz İçin <span className="text-yellow-300">Anahtar Teslim</span> Çözüm
            </h3>
            {/* KONTRAST İYİLEŞTİRME: text-blue-100 → text-white/90 */}
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 text-blue-100 text-xs">
              ...
              <div className="hidden sm:block w-px h-3 bg-blue-400" aria-hidden="true" />
              <div className="flex items-center gap-1">
                <div className="w-1.5 h-1.5 bg-green-400 rounded-full animate-pulse" aria-hidden="true" />
