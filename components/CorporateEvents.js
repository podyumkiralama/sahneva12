                    ...
                    <div className="flex-1 p-6 flex flex-col">
                      ...
                      <div className="pt-4 border-t border-white/10 mt-auto">
                        <Link
                          ...
                          className={`inline-flex items-center gap-2 font-bold text-xs text-white underline decoration-white/50 underline-offset-4 hover:text-blue-400 hover:decoration-blue-400 transition-colors group/link ${FOCUS_RING_CLASS}`}
