      ...
      <div className="relative z-10 grid gap-12 p-8 md:p-12 lg:p-16 lg:grid-cols-[1.2fr_0.8fr] items-center">
        ...
        <div className="flex flex-col gap-10">
          ...
          <ScrollReveal direction="up" delay="0.05">
            <div>
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-500/30 bg-blue-500/10 px-4 py-1.5 text-xs font-bold uppercase tracking-widest text-blue-300 backdrop-blur-sm">
              ...
              >
                ...
                mühendislik hassasiyetiyle planlıyor, markanıza yakışan
                kusursuz bir atmosfer yaratıyoruz.
              </p>
            </div>
          </ScrollReveal>
              ...
              {[
                {
                  ...
                  desc: "Markaya özel 3D modelleme ve dekor.",
                  border: "border-blue-500/20",
                },
                {
                  title: "Görüntü Sistemleri",
                  desc: "Yüksek çözünürlüklü LED ekran ve Watchout.",
                ...
                <div
                  key={idx}
                  className={`rounded-2xl border ${item.border} bg-white/5 p-5 backdrop-blur-sm transition-transform hover:-translate-y-1 hover:bg-white/10`}
                >
        ...
        <ScrollReveal direction="left" delay="0.2">
          <div className="relative group">
            ...
            <div
              className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-blue-600 to-purple-600 opacity-30 blur-lg transition duration-1000 group-hover:opacity-50"
              aria-hidden="true"
            />

            <div className="relative aspect-[4/5] min-h-[500px] overflow-hidden rounded-2xl border border-white/10 bg-slate-900 shadow-2xl lg:aspect-auto lg:h-full">
              <Image
                src="/img/kurumsal/kurumsal-sahne-led-ekran.webp"
                alt="Kurumsal lansman için kurulmuş sahne ve LED ekran prodüksiyonu"
                fill
                loading="lazy"
              ...
              {/* Görsel Üzeri HUD Tarzı Bilgi */}
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="flex flex-col gap-4">
                  {/* Etiketler */}
                  <div className="flex flex-wrap gap-2">
                    <span className="inline-flex items-center gap-1.5 rounded-md border border-emerald-500/30 bg-emerald-500/20 px-3 py-1 text-xs font-semibold text-emerald-300 backdrop-blur-md">
                      <span
                    ...
                    <span className="inline-flex items-center rounded-md border border-white/10 bg-white/10 px-3 py-1 text-xs font-semibold text-white backdrop-blur-md">
                      P3.9 LED Screen
                    </span>
                  </div>
                  ...
                  <div
                    className="mt-2 h-0.5 w-full bg-gradient-to-r from-blue-500/50 to-transparent"
                    aria-hidden="true"
                  />
                </div>
              </div>
