...
export default function CorporateIntro() {
  return (
    <section
      ...
      className="relative py-16 md:py-24 bg-slate-950 overflow-hidden border-t border-slate-900"
    >
      {/* ———————————————————————————
      ...
      {/* ———————————————————————————
          İÇERİK WRAPPER (max-w-7xl, ServicesTabs ile aynı)
      ——————————————————————————— */}
