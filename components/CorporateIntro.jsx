...
export default function CorporateIntro() {
  return (
    <section
      ...
      className="relative bg-[#020617] py-16 md:py-20 lg:py-24 overflow-hidden border-t border-slate-900"
    >
      {/* ARKA PLAN GRID + GLOW */}
      <div className="pointer-events-none absolute inset-0" aria-hidden="true">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#0f172a55_1px,transparent_1px),linear-gradient(to_bottom,#0f172a55_1px,transparent_1px)] bg-[size:40px_40px]" />
        <div className="absolute -top-40 right-[-80px] w-[320px] h-[320px] bg-cyan-500/18 blur-[110px] rounded-full mix-blend-screen" />
        <div className="absolute -bottom-40 left-[-80px] w-[320px] h-[320px] bg-sky-500/14 blur-[110px] rounded-full mix-blend-screen" />
      </div>
