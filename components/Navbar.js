        ...
        <div className="container">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:flex items-center gap-4">
              ...
              {/* ✅ NEW: Search icon -> /yardim */}
              <Link
                href="/yardim"
                className={`inline-flex items-center justify-center h-11 w-11 rounded-xl border border-neutral-200 bg-white hover:bg-neutral-50 text-neutral-700 hover:text-blue-700 transition-all duration-200 shadow-sm hover:shadow-md ${FOCUS_RING_CLASS}`}
                aria-label="Arama ve Yardım"
                title="Arama"
              >
                <svg
                  viewBox="0 0 24 24"
