        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          <article className="rounded-3xl bg-white/5 border border-white/10 p-6 md:p-8 shadow-[0_18px_45px_rgba(15,23,42,0.8)]">
            <div className="flex items-start gap-3">
              ...
              <h3 className="text-xl md:text-2xl font-bold text-white leading-snug">Uçtan Uca Teknik Hizmet ve Profesyonel Çözümler</h3>
            </div>
            <p className="mt-4 text-slate-300 text-sm md:text-base leading-relaxed">Sahneva olarak Türkiye genelinde sahne, podyum, LED ekran ve ses ışık sistemleri alanlarında komple teknik çözümler sunuyoruz.</p>
          ...
          <article className="rounded-3xl bg-white/5 border border-white/10 p-6 md:p-8 shadow-[0_18px_45px_rgba(15,23,42,0.8)]">
            <div className="flex items-start gap-3">
              <div className="text-3xl" aria-hidden="true">🎤</div>
              <h3 className="text-xl md:text-2xl font-bold text-white leading-snug">Büyük Ölçekli Etkinlikler İçin Güçlü Altyapı</h3>
            </div>
            <p className="mt-4 text-slate-300 text-sm md:text-base leading-relaxed">Konser, miting, festival, fuar ve açık hava etkinlikleri için yüksek kapasiteli ekipman altyapımızla hizmet veriyoruz.</p>
            <ul className="mt-5 space-y-2 text-sm md:text-[15px] text-slate-200 leading-relaxed">
        ...
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {DEFAULT_FEATURES.map((feature) => (
            <li key={feature.title}>
              <div className="group relative overflow-hidden rounded-2xl p-6 bg-slate-900/70 border border-white/10 shadow-[0_18px_45px_rgba(0,0,0,0.6)] transition-all duration-500 hover:-translate-y-[4px] hover:shadow-[0_26px_70px_rgba(56,189,248,0.45)]">
                <div className="pointer-events-none absolute inset-0" aria-hidden="true">
                  <div className="absolute left-1/2 -translate-x-1/2 bottom-[-34px] w-56 h-56 rounded-full blur-[55px] opacity-80 bg-purple-500/45 transition-[background-color,opacity] duration-500 group-hover:bg-sky-500/55 group-hover:opacity-100" />
                </div>
                <div className={`pointer-events-none absolute inset-0 bg-gradient-to-br ${feature.gradient} opacity-[0.03] group-hover:opacity-[0.08] transition-opacity duration-500`} />
                <div className="relative z-10 space-y-4">
                  <div className="mb-3">
                    <div className={`inline-flex items-center justify-center rounded-2xl p-3 bg-slate-950/80 ring-1 ring-white/10 shadow-[0_0_30px_rgba(15,23,42,0.9)] bg-gradient-to-br ${feature.gradient}`}>{feature.icon}</div>
                  </div>
                  ...
                  <h3 className={`text-lg font-semibold mt-1 text-slate-50 group-hover:${feature.accentText} transition-colors duration-300`}>{feature.title}</h3>
