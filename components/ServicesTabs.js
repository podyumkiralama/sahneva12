...
function formatTitleTemplate(template, title, fallback) {
  ...
  if (typeof fallback === "function") return fallback(title);
  if (typeof fallback === "string") return fallback.replace(TITLE_TEMPLATE_TOKEN, title);
    ...
    <div className="w-full">
      ...
      <ScrollReveal asChild>
        <div className="relative mb-12">
          ...
          {/* Sağ tarafta gradient overlay (scroll ipucu) */}
          <div
