  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute -top-24 right-[-40px] w-[260px] h-[260px] bg-cyan-500/15 blur-[90px] rounded-full mix-blend-screen" />
        <div className="absolute -bottom-24 left-[-40px] w-[220px] h-[220px] bg-sky-500/10 blur-[80px] rounded-full mix-blend-screen" />
      </div>
      ...
      <div className="relative z-10 px-4 mx-auto w-full max-w-7xl">
        ...
        <div className="w-full">
          ...
          <ScrollReveal direction="up" delay="0.2">
            <div
              className="relative overflow-hidden bg-[#020617] border border-slate-800 rounded-2xl shadow-2xl transition-all duration-500 focus:outline-none focus-visible:ring-4 focus-visible:ring-cyan-600/40"
              role="tabpanel"
