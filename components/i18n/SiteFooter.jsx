...
export default function SiteFooter({ strings }) {
  ...
  return (
    <footer className="bg-slate-950 text-slate-200" dir={strings.direction}>
          ...
          <div>
            ...
            <div className="mt-4 space-y-2 text-sm">
              <p>
                ...
                <a href="tel:+905453048671" className="hover:text-emerald-300">
                  +90 545 304 86 71
                </a>
              </p>
              <p>
                <strong>{strings.mailLabel}:</strong>{" "}
                <a href="mailto:info@sahneva.com" className="hover:text-emerald-300">
                  info@sahneva.com
                </a>
              </p>
            </div>
            ...
            <div className="mt-4 flex flex-wrap gap-3 text-sm">
              {strings.social.map((item) => (
                <a
                  ...
                  className="rounded-full border border-white/15 px-3 py-1 hover:border-emerald-300 hover:text-emerald-300 transition"
                >
                  {item.label}
                </a>
              ))}
