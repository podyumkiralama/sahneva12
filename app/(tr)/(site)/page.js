...
export default function HomePage() {
  return (
    <div className="overflow-x-hidden">
      ...
      {/* HERO SECTION */}
      <section
        className="relative -mt-16 lg:-mt-20 pt-24 md:pt-28 lg:pt-32 min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0b0f1a] via-blue-950 to-purple-950"
