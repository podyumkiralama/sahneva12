...
// PERFORMANS: Off-screen içeriği hızlıca atlamak + scroll zıplamasını azaltmak için
        ...
        <div className="relative z-10 container py-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <ScrollReveal delay="1" asChild>
              ...
              >
                Türkiye Geneli Profesyonel Sahne, Podyum ve LED Ekran
                Kiralama Çözümleri
              </h1>
            </ScrollReveal>
            ...
            <ScrollReveal delay="2">
              <>
                ...
                <p className="text-slate-100 text-sm md:text-lg mt-2 md:mt-4 max-w-3xl mx-auto leading-relaxed">
                  500+ başarılı proje, %98 müşteri memnuniyeti ve Türkiye
                  geneli hızlı kurulum ile etkinliğinizde yanınızdayız.
                  Kurumsal etkinlikler, bayi toplantıları, konserler,
                  festivaller ve açık hava organizasyonları için sahne
                  kiralama, podyum kiralama, LED ekran kiralama, ses-ışık
                  sistemleri ve yayın altyapısını tek merkezden sunuyoruz.
                </p>
                ...
                <p className="text-slate-100/90 text-xs md:text-base mt-3 max-w-3xl mx-auto leading-relaxed">
                  ...
                  koruyor, profesyonel teknik ekibimizle her şehirde güvenli
                  ve ölçülebilir performans sağlıyoruz. Teknik ekipman
                  listesinden lojistik planlamaya, içerik yönetiminden sahne
                  önü güvenlik adımlarına kadar her aşamayı şeffaf biçimde
                  raporluyor; olası risklere karşı yedek senaryolar hazır
                  tutarak marka deneyiminizi güvence altına alıyoruz.
                </p>
              </>
            </ScrollReveal>
