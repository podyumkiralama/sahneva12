...
export default function HomePage() {
  return (
    <div className="overflow-x-hidden">
      ...
      {/* HERO SECTION */}
      <section
        className="relative -mt-16 lg:-mt-20 pt-32 md:pt-36 lg:pt-44 min-h-[80vh] flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0b0f1a] via-blue-950 to-purple-950"
