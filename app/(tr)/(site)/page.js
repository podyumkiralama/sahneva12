...
// 2. Client / Lazy Load Bileşenler (ReviewBannerDeferred kaldırıldı)
import {
...
// —————————————————————————————————————————
// JSON-LD (Schema.org) - SEO VERİLERİ (Aynı kaldı)
// —————————————————————————————————————————
...
      {/* 7. TEKNİK KAPASİTE (Önceki 8. bölüm) */}
      <TechCapabilities />

      {/* 8. SSS (FAQ) (Önceki 9. bölüm) */}
