    ...
    "@graph": [
      {
        ...
        description: "Sahneva ile profesyonel sahne, podyum, LED ekran, ses ve ışık sistemleri kiralama çözümlerini keşfedin. İstanbul merkezli, Türkiye geneli hızlı kurulum.",
        inLanguage: "tr-TR",
      ...
      },
      {
        ...
        description: "Türkiye genelinde sahne, podyum, LED ekran, ses-ışık sistemleri ve çadır kiralama hizmeti. Kurulum, teknik operasyon ve söküm dahil.",
        url: HOME_URL,
        areaServed: { "@type": "Country", name: "Türkiye" },
      ...
      },
      {
        ...
        description: "Sahneva'nın sahne, podyum, LED ekran ve ses-ışık sistemleriyle gerçekleştirdiği kurulum ve etkinliklerden kısa bir özet.",
  ...
  return (
    <div className={`${alignment} mb-10 md:mb-14 ${className}`}>
      <div className="inline-flex items-center gap-2 mb-3">
        <div className="w-3 h-6 bg-gradient-to-b from-blue-500 to-purple-500 rounded-full"></div>
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center gap-6 md:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-slate-200 text-base md:text-lg leading-relaxed">
              Etkinliğiniz için <strong className="text-yellow-300">en uygun sahne çözümleri</strong>, LED ekran seçenekleri ve ses-ışık sistemlerini ücretsiz teknik danışmanlık ile planlayalım.{" "}
...
export default function HomePage() {
  return (
    <div className="overflow-x-hidden">
        ...
        >
          <div className="animate-bounce">
            <div className="w-8 h-14 border-2 border-white/30 rounded-full flex justify-center">
              <div className="w-1.5 h-3 bg-gradient-to-b from-white to-white/70 rounded-full mt-3"></div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* TEKLİF AL HEDEFİ */}
      <div id="teklif-al" className="scroll-mt-24"></div>
                ...
                >
                  <div className="group relative bg-white rounded-2xl p-6 shadow-xl hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-transparent overflow-hidden">
                    ...
                    <div className="relative z-10 mb-6">
                      <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${feature.gradient} flex items-center justify-center text-2xl text-white shadow-lg`}>
                        {feature.icon}
                      </div>
                    </div>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-white rounded-3xl p-8 shadow-2xl border border-blue-100 hover:border-blue-200 transition-colors duration-300">
                ...
                <div className="space-y-4">
                  <p className="text-gray-700 leading-relaxed">
                    <strong className="text-blue-700">Sahneva</strong> olarak Türkiye genelinde{" "}
                    <Link href="/sahne-kiralama" className="text-blue-600 hover:text-blue-700 font-semibold underline underline-offset-4 decoration-2 transition-colors">
                      sahne kiralama
                    </Link>
                    ,{" "}
                    <Link href="/podyum-kiralama" className="text-blue-600 hover:text-blue-700 font-semibold underline underline-offset-4 decoration-2 transition-colors">
                      podyum kurulumu
                    </Link>
                    ,{" "}
                    <Link href="/led-ekran-kiralama" className="text-blue-600 hover:text-blue-700 font-semibold underline underline-offset-4 decoration-2 transition-colors">
                      LED ekran kiralama
                    </Link>{" "}
                    ve{" "}
                    <Link href="/ses-isik-sistemleri" className="text-blue-600 hover:text-blue-700 font-semibold underline underline-offset-4 decoration-2 transition-colors">
