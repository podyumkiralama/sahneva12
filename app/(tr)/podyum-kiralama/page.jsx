  ...
  () => import("@/components/PriceEstimatorPodyum"),
  {
    loading: () => (
      <div
        className="flex justify-center items-center h-64"
        role="status"
        aria-label="Fiyat hesaplayıcı yükleniyor"
      >
        <div
          className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"
          aria-hidden="true"
...
export const metadata = {
  ...
  openGraph: {
    title: "Podyum Kiralama | Profesyonel Sahne Çözümleri | Sahneva",
    description:
      "Modüler podyum sistemleri, kaymaz kaplama ve profesyonel kurulum. Konser, düğün, lansman etkinlikleri için ideal çözümler.",
  ...
  twitter: {
    ...
    title: "Podyum Kiralama | Profesyonel Sahne Çözümleri | Sahneva",
    description:
      "Modüler podyum kiralama, kaymaz kaplama, halı ve skört opsiyonları. Profesyonel kurulum ve teknik destek.",
...
function JsonLd() {
  ...
  const safeProducts = productNodes.filter(
  ...
  const serviceNode =
    serviceSchema != null ? { ...serviceSchema, ...baseService } : baseService;
  ...
  const howToSchema = {
    ...
    step: [
      { "@type": "HowToStep", name: "Keşif ve Planlama", text: "Mekan keşfi yapılır ve teknik projelendirme hazırlanır." },
      { "@type": "HowToStep", name: "Zemin Hazırlığı", text: "Zemin düzleştirilir ve güvenlik kontrolleri yapılır." },
      { "@type": "HowToStep", name: "Podyum Kurulumu", text: "Modüler paneller monte edilir ve güvenlik sistemleri kurulur." },
      { "@type": "HowToStep", name: "Kalite Kontrol", text: "Kurulum sonrası güvenlik ve stabilite kontrolleri yapılır." }
    ]
  };
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Podyum kiralama hizmetlerimiz: keşif, projelendirme, kurulum, teknik
            destek ve söküm
          </p>
        </div>
...
function PriceCalculator() {
  return (
    <section
      ...
      aria-labelledby="fiyat-hesaplayici-baslik"
    >
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2
            id="fiyat-hesaplayici-baslik"
            className="text-4xl md:text-5xl lg:text-6xl font-black mb-6 text-gray-900"
          >
            Hızlı{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">
  ...
  const enrichedPkgs = CONTENT.packages.map((p) => {
    ...
    return {
      ...
      price: {
        ...
        carpet,
        skirt,
        withCarpetAndSkirt: carpet + skirt,
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-8">
          <p className="text-gray-600 text-lg">
            *Fiyatlar haftalık kiralama içindir. Günlük kiralama için iletişime
            geçin.
          </p>
        </div>
      </div>
    ...
    >
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto">
          <CaseGallery
            images={CONTENT.gallery.map((src) => ({
              src,
  ...
  const technicalItems = [
    {
      ...
      description:
        "Alüminyum karkas, çelik bağlantı elemanları ve kaymaz kaplama",
      features: [
        "Alüminyum karkas sistem",
    ...
    },
    {
      ...
      description:
        "Podyum kurulumunu tamamlayan profesyonel hizmetler",
      features: [
        "Halı kaplama sistemleri",
        "Skört (etek) kaplama",
      ...
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/85 max-w-3xl mx-auto leading-relaxed">
            Podyum çözümlerimizin tercih edildiği başlıca etkinlik türleri ve
            özel çözümlerimiz
          </p>
          <div
    ...
    >
      <div className="container max-w-7xl mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Podyum kurulumunuzu tamamlayacak diğer profesyonel etkinlik
            çözümlerimiz
          </p>
          <div
        ...
        <div className="sr-only">
          <p>
            Bu bölümde podyum kurulumunuzu tamamlayacak diğer hizmetlerimiz
        ...
        <div className="bg-gradient-to-r from-blue-700 to-purple-700 rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-blue-100 text-xl mb-8 max-w-3xl mx-auto leading-relaxed">
              Etkinliğiniz için en uygun podyum sistemlerini sunalım. Ücretsiz
