      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-12">
            ...
            <Link
              href="/en/projects"
              className="inline-flex items-center justify-center font-bold px-8 py-4 rounded-2xl border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white transform transition-all duration-300 focus:outline-none focus-visible:ring-4 focus-visible:ring-purple-600"
            >
              <span aria-hidden="true" className="text-xl mr-3">📸</span>
