...
// ✅ FAQ JSON-LD (Sadece bu sayfaya özel)
    ...
    "mainEntity": [
      {
        ...
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Ölçülere ve zemine göre genellikle 1–3 saat sürer."
        }
      },
      {
        "@type": "Question",
        "name": "LED ekran dış mekanda kullanılabilir mi?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Evet, IP65 korumalı paneller dış mekanda güvenle kullanılabilir."
        }
      },
      {
        "@type": "Question",
        "name": "Teknik ekip sağlıyor musunuz?",
        "acceptedAnswer": {
          "@type": "Answer",
          "text": "Evet, kurulum ve etkinlik boyunca profesyonel teknik ekip sağlıyoruz."
        }
      }
    ]
  };
...
export default function HomePage() {
  return (
    <div className="overflow-x-hidden">
      {/* ✅ FAQ JSON-LD sadece burada çalışır, layout ile çakışmaz */}
      <HomeFaqJsonLd />
      ...
      {/* ANA İÇERİK (layout’taki <main> ile çakışmaması için <div>) */}
