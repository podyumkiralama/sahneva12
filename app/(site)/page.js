...
// Client bileşenlerini sadece dinamik yükle
...
// ❌ METADATA YOK - LAYOUT'DAKİLER KULLANILACAK

export default function HomePage() {
  return (
    <div className="overflow-x-hidden">
      {/* ❌ SKIP LINK YOK - SADECE LAYOUT'DA */}
      ...
      {/* ❌ ANA İÇERİK LANDMARK'I YOK - LAYOUT'DAKİ KULLANILACAK */}
