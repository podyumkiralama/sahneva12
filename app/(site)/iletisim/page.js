...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-white overflow-hidden">
            ...
            <ScrollReveal>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-neutral-600 max-w-3xl mx-auto">
                  Size en uygun iletişim yöntemiyle hemen bize ulaşın, 2 saat içinde
                  yanıt verelim
                </p>
              ...
              <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                ...
                <ScrollReveal delay="1" direction="up">
                  <ContactCard
                    ...
                    ariaLabel="Sahneva'ya WhatsApp'tan mesaj gönder"
                  />
                </ScrollReveal>

                <ScrollReveal delay="2" direction="up">
                  <ContactCard
                    icon="✉️"
                    title="E-posta"
                    info={MAIL}
                    ...
                    ariaLabel="Sahneva'ya e-posta gönder"
                  />
                </ScrollReveal>
              </div>
            </ScrollRevealGroup>
                ...
                <div className="space-y-8">
                  <div className="text-center lg:text-left">
                    ...
                    <p className="text-xl text-neutral-600 mb-8">
                      Türkiye geneli hizmet veriyoruz. Ofisimizi ziyaret etmek için
                      haritayı kullanabilirsiniz.
                    </p>
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-lg border border-neutral-100">
                    ...
                    <div className="space-y-4">
                      <InfoRow label="Telefon" icon="📞">
                        <a
                          href={`tel:${PHONE}`}
                          className="inline-flex items-center justify-center px-3 py-2 rounded-lg text-blue-700 bg-blue-50 border border-blue-100 font-medium text-sm md:text-base"
                        >
                          {PHONE}
                        </a>
                      </InfoRow>
                      ...
                      <InfoRow label="E-posta" icon="✉️">
                        <a
                          href={`mailto:${MAIL}`}
                          className="inline-flex items-center justify-center px-3 py-2 rounded-lg text-purple-700 bg-purple-50 border border-purple-100 font-medium text-sm md:text-base"
                        >
                          {MAIL}
                        </a>
                      </InfoRow>
                ...
                >
                  <div className="text-center mb-8">
                    ...
                    <p className="text-neutral-600">
                      Etkinlik bilgilerinizi bırakın, 2 saat içinde detaylı teklif
                      sunalım
                    </p>
                  </div>
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl p-12 border border-white/20">
                ...
                <div className="mt-8 p-4 bg-yellow-500/20 rounded-xl border border-yellow-400/30 max-w-2xl mx-auto">
                  <p className="text-yellow-200 text-sm">
                    <strong>⏰ 7/24 Hizmet:</strong> Mevcut etkinliklerinizde yaşadığınız
                    teknik sorunlarda aynı gün içinde çözüm sunuyoruz.
                  </p>
                </div>
              </div>
            </ScrollReveal>
      ...
      {/* Mobile CTA Bar – dokunma hedefleri büyütüldü */}
      <div className="fixed bottom-0 left-0 w-full bg-white shadow-2xl border-t py-3 flex justify-around md:hidden z-50">
        <a
          href={`tel:${PHONE}`}
          className="flex flex-col items-center justify-center text-blue-600 font-bold text-xs gap-1 px-4 py-1"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center justify-center text-green-600 font-bold text-xs gap-1 px-4 py-1"
        >
          <span className="text-lg">💬</span>
          <span>WhatsApp</span>
        </a>
        <a
          href="#teklif-formu"
          className="flex flex-col items-center justify-center text-purple-600 font-bold text-xs gap-1 px-4 py-1"
        >
          <span className="text-lg">📝</span>
          <span>Teklif Al</span>
        </a>
...
function ContactCard({
  ...
  return (
    <article className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl border border-neutral-100 hover:border-blue-200 transition-all duration-500 hover:scale-105 text-center">
      <div
      ...
      <a
        ...
        className={`inline-flex items-center justify-center bg-gradient-to-r ${color} hover:shadow-xl text-white font-bold px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 shadow-lg min-w-[180px]`}
