...
export default function ContactPage() {
  return (
    <div className="min-h-screen bg-white overflow-hidden">
      ...
      {/* MAIN (mobil bar için padding eklendi) */}
      <main id="main" className="relative pb-24 md:pb-0">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-12 border border-white/20">
              ...
              <div className="mt-8 p-4 bg-yellow-500/20 rounded-xl border border-yellow-400/30 max-w-2xl mx-auto">
                <p className="text-yellow-200 text-sm">
                  ...
                  yaşadığınız teknik sorunlarda aynı gün içinde çözüm sunuyoruz.
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Mobil bar için ekstra boşluk (bar ile içerik çakışmasın) */}
        <div className="h-24 md:hidden" aria-hidden="true" />
      </main>

      {/* Mobile CTA Bar */}
      <div
        className="fixed inset-x-0 bottom-0 md:hidden z-40 bg-white shadow-2xl border-t py-3 flex justify-around"
        style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}
      >
        <a
          href={`tel:${PHONE}`}
          className="flex flex-col items-center text-blue-700 font-bold text-xs"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex flex-col items-center text-green-700 font-bold text-xs"
        >
          <span className="text-lg">💬</span>
          <span>WhatsApp</span>
        </a>
        <a
          href="#teklif-formu"
          className="flex flex-col items-center text-purple-700 font-bold text-xs"
        >
          <span className="text-lg">📝</span>
          <span>Teklif Al</span>
        </a>
